...
function LiveRoom({ userRole, onEndCall }: { userRole: "teacher" | "learner"; onEndCall: () => void }) {
  ...
  const toggleHand = async () => {
    ...
    await localParticipant.publishData(new TextEncoder().encode(JSON.stringify({ type: "hand", raised: next })), { reliable: true })
    setHandRaised(next)
