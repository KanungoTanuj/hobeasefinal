...
function LiveRoom({ userRole, onEndCall }: { userRole: "teacher" | "learner"; onEndCall: () => void }) {
  ...
  return <div ref={stageRef} className="relative flex min-h-0 flex-1 flex-col overflow-hidden bg-[#18232c] text-white">
    <RoomAudioRenderer />
